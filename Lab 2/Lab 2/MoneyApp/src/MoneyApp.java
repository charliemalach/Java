...
public class MoneyApp {
    public static void main(String[] args) {
        ...
        Money[] ledger = new Money[5]; //new money array 
        // Money m1 = new Money();
        ...
        printLedger(ledger);
        System.out.println(ledger[0] + " is equal to " + ledger[1] + ": " + ledger[0].equal(ledger[1]));
        System.out.println(ledger[1] + " is equal to " + ledger[1] + ": " + ledger[1].equal(ledger[1]));
        // System.out.println(searchLedger(ledger, ledger[1])); 
        System.out.println(ledger[1] + " was found: " + searchLedger(ledger, ledger[1]));
        System.out.println(m3 + " was found: " + searchLedger(ledger, m3));
    ...
    public static boolean searchLedger(Money[] arrayLedger, Money target){ //search for ledger
        int count = 0;
        while (target != arrayLedger[count] && count >= arrayLedger.length){
    ...
    public static void Sort(Money[] arrayLedger){ //sort array ledger from smallest value to largest value 
        for (int i = 0; i < arrayLedger.length; i++){
